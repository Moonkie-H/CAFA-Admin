 ...
 *
 * `read` has to be stable across renders — define it at module scope, or wrap
 * it in `useCallback`. It is in the effect's dependencies, so a fresh function
 * every render is a fresh request every render.
 */
